...
<img classe="logo" src="images/logo.jpg"> 
    ...
    <ul class="navbar-nav">
    <li class="nav-item">
    <h3>  <a   class="nav-link" href="login.php"><?php session_start(); echo "Olá, ".$_SESSION["autor"]->Nome; ?></a></h2>
     </li>
     <li class="nav-ite">
    <h3>  <a   class="nav-link" href="logout.php">Logout</a></h2>
     </li> 
</ul>
</nav>
<div class="container" style="margin-top:30px">
    ...
    <div class="col-lg-3 col-md-6">
        ...
        <div class="col-sm-9">
           ...
           <?php $comentarioController->create(); ?>
        </div>
